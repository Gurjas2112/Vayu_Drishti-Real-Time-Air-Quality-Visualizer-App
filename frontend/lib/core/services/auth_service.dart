...
class AuthService {
  ...
  // Constructor - auto login for prototype testing
  AuthService() {
    _autoLogin();
  }

  // Auto login with mock credentials for prototype testing
  Future<void> _autoLogin() async {
    if (!_hasAutoLoggedIn) {
      _hasAutoLoggedIn = true;
      // Auto login with the email from the image
      await Future.delayed(const Duration(milliseconds: 500));
      _currentUser = User.fromJson(
        _mockUsers['gurjasgandhi76@gmail.com']!['user'],
      );
